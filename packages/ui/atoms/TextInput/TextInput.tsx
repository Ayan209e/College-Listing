...
export const TextInput = ({
  ...
  return (
    <div className="relative flex flex-col bg-transparent w-full">
      ...
      <input
        className={cn(
          "px-3 py-2 rounded-md placeholder:text-gray focus:outline-none h-10 w-full backdrop-blur-sm disabled:opacity-50 disabled:pointer-events-none",
          {
      ...
      {icon && isValidElement(icon) && (
        <div className="absolute top-[11px] left-[10px]">{icon}</div>
      )}
    </div>
  );
};
